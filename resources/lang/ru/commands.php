...
return [
    ...
    'install' => [
        ...
        'running_migrations' => 'Выполнение миграций',
        'seeding_permissions' => 'Заполнение разрешений и ролей',
        'run_migrations_confirm' => 'Выполнить миграции и заполнить стандартные разрешения сейчас?',
        'step_seed' => 'Заполнить стандартные разрешения и роли:',
    ],
