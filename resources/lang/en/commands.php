...
return [
    ...
    'install' => [
        ...
        'stepGates' => 'Define authorization gates in your service provider:',
        'stepMigrate' => 'Run migrations:',
        'stepTailwind' => 'Add Escalated pages to Tailwind source scanning:',
        'stepInertia' => 'Add the Escalated resolver to your existing Inertia/Vue app.ts:',
