...
return [
    ...
    'install' => [
        ...
        'seeding_permissions' => 'Sembrando permisos y roles',
        'run_migrations_confirm' => '¿Ejecutar las migraciones y sembrar los permisos por defecto ahora?',
        'step_seed' => 'Sembrar permisos y roles por defecto:',
    ],
