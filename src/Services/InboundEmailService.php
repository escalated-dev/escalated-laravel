...
class InboundEmailService
{
    ...
    protected function createNewTicket(InboundMessage $message, ?Ticketable $user): Ticket
    {
        ...
        // Guest ticket — follow the same guest-policy branching as
        // WidgetController::createTicket so the admin settings page
        // affects inbound-created tickets too. See
        // src/Http/Controllers/WidgetController.php:createTicket for
        ...
        if ($mode === 'guest_user') {
            ...
            if ($guestUserId > 0) {
                ...
                // Misconfigured guest_user (zero / missing id): fall
